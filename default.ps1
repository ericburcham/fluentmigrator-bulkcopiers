...
task BuildDebugWithPrerequisites -description "Builds FluentMigrator.FastDataLoader.sln in the debug configuration.  Runs prerequisite steps first." -depends RestorePackages, BuildDebug
